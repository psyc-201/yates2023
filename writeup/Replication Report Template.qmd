...
About 30 adult participants will be recruited for the final project. This sample size was according to Hsiung & Chien (2024.) They conducted a power analysis and determined that 24 neurotypical and ASD adults are a good number. I uploaded that paper to my original_paper folder.
...
About 30 adults (# female gender, # other gender) participants (M age = X years, SD = Y, range = X-Y) will be recruited for the final project. This sample size was according to Hsiung & Chien (2024). "This sample size was calculated according to Rosner et al. (2005) and was determined based on power consideration (i.e., we set the type 1 error (α) to 0.05, the power (1-β) at approximately 0.84, leading to an expected sample size of 24)." 
Participants will be excluded from analyses if they respond at or below chance level (50% correct). The aimed final sample size is 24 adults
...
Adults are asked to decide whether the top parts of the faces (i.e., the tops) of these composite faces were the same or different. Participants will receive feedback during the practice trials. Thus an incorrect response will prompt them to "Try Again." A correct response will confirm their accuracy: "Great job! The top parts of the face are the same." During the second practice trial, participants will see a pair of spatially misaligned composite faces where the top halves were of the same face and were once again asked whether the top parts” of these faces were the same or different. Again, if participants made an incorrect choice, they will be prompted to try again, and they got positive response for the correct choice.
...
"During each trial, participants were prompted to respond whether the faces were the same or different by clicking on one of two buttons visible on the screen corresponding to these choices (see Fig. 1B). Participants were also reminded after 10, 20, and 30 trials that they were supposed to answer whether the "top parts” of the face were the same or different. A click of one of the two response buttons was required to advance the experiment to the next trial. Participants had unlimited time to respond."
...
My study diverged from Yates and Lewkowicz in a few methodological aspects. The original study had 36 trials, my experiment will have 96. This still fits adult's attention span. Additionally, children in the original study had no time limit on viewing the stimulus and to respond. Here, we only showed each face pair to participants for 1 second, and ste the response limit to 3 seconds. Given the increase in the number of trials, I also made more face stimuli. The original study showed kids 24 unique face pairs, the current study showed participants 64 unique face pairs to ensure participants' see unique face stimuli for most of the trials. The original study also added a putple tint to the top halves of the faces to direct children's attention -- here, we used black and white stimuli. Additionally, I extended the dependent measures beyond the original study by recording reaction times and performing supplementary RT related analyses. I added a demographic questionnaire and the Social Responsiveness Scale (SRS-2 Adult) to assess participants social abilities, and am not using the Covid-19 mask related questionnaire the authors included originally, to measure the relationship between mask exposure and face processing.
Finally, when it comes to analyses, the original study analyzed accuracy scores by different age groups (separately the 4, 5 and 6 year olds' data). In this study, I will nto include age in my ANOVA, given that all participants will be above 18, and i am not looking at the developmental trajectory of face processing.
...
SRS
For both accuracy and reaction time data, we will explore potential relationships between social responsiveness and holistic face processing. First, we will examine whether SRS total scores correlate with overall task performance by conducting Pearson correlations between SRS scores and (a) average accuracy across all trials and (b) average reaction time across all trials. More critically, to test whether individual differences in social responsiveness relate specifically to holistic processing, we will examine correlations between SRS scores and the composite face effect magnitude, calculated as the difference in accuracy (and reaction time) between aligned-same and misaligned-same trials.  

*Side-by-side graph with original graph is ideal here*

### Exploratory analyses

The SRS related analyses I described above will be exploratory analyses.

### Analyses

See stats_finak_analyses.qmd on yates2023 repo!
